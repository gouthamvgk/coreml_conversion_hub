...
#mobilenetv3_minimal_small conversion
mobilenetv3_small_min_url = "https://storage.googleapis.com/mobilenet_v3/checkpoints/v3-small-minimalistic_224_1.0_float.tgz"
os.system("wget {}".format(mobilenetv3_small_min_url))
os.system("tar -xvf v3-small-minimalistic_224_1.0_float.tgz")

mbv3_small_min_pb = "./v3-small-minimalistic_224_1.0_float/v3-small-minimalistic_224_1.0_float.pb"
with tf.compat.v1.gfile.GFile(mbv3_small_min_pb, "rb") as f: 
...
with tf.compat.v1.gfile.GFile("mbv3_small_min_cleaned.pb", "wb") as f:
    f.write(reduced_graph.SerializeToString())

#if we are converting from pb then we shouldn't strip the '/' from tensor names
mobilenetv3_small_min_mlmodel = tfcoreml.convert(
"mbv3_small_min_cleaned.pb",
...
spec = mobilenetv3_small_min_mlmodel._spec #changing this spec will automatically reflect in mlmodel properties
...
mobilenetv3_small_min_mlmodel.short_description = "Mobilenet V3-small-min imagnet model"
mobilenetv3_small_min_mlmodel.license = "Open source academic license"
mobilenetv3_small_min_mlmodel.save("mobilenetV3_small_min.mlmodel")