...
#mobilenetv3_minimal_large conversion
mobilenetv3_large_min_url = "https://storage.googleapis.com/mobilenet_v3/checkpoints/v3-large-minimalistic_224_1.0_float.tgz"
os.system("wget {}".format(mobilenetv3_large_min_url))
os.system("tar -xvf v3-large-minimalistic_224_1.0_float.tgz")

mbv3_large_min_pb = "./v3-large-minimalistic_224_1.0_float/v3-large-minimalistic_224_1.0_float.pb"
with tf.compat.v1.gfile.GFile(mbv3_large_min_pb, "rb") as f: 
...
with tf.compat.v1.gfile.GFile("mbv3_large_min_cleaned.pb", "wb") as f:
    f.write(reduced_graph.SerializeToString())

#if we are converting from pb then we shouldn't strip the '/' from tensor names
mobilenetv3_large_min_mlmodel = tfcoreml.convert(
"mbv3_large_min_cleaned.pb",
...
spec = mobilenetv3_large_min_mlmodel._spec #changing this spec will automatically reflect in mlmodel properties
...
mobilenetv3_large_min_mlmodel.short_description = "Mobilenet V3-large-min imagnet model"
mobilenetv3_large_min_mlmodel.license = "Open source academic license"
mobilenetv3_large_min_mlmodel.save("mobilenetV3_large_min.mlmodel")